...
CREATE TABLE `equity_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='所权益明细表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-08-15 17:30:05
